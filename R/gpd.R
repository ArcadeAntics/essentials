...
.External2(C_dgpd, x, location, scale, shape, log)


pgpd <- function (q, location = 0, scale = 1, shape = 0, lower.tail = TRUE,
    log.p = FALSE)
.External2(C_pgpd, q, location, scale, shape, lower.tail, log.p)


qgpd <- function (p, location = 0, scale = 1, shape = 0, lower.tail = TRUE,
    log.p = FALSE)
.External2(C_qgpd, p, location, scale, shape, lower.tail, log.p)


rgpd <- function (n, location = 0, scale = 1, shape = 0)
.External2(C_rgpd, n, location, scale, shape)
