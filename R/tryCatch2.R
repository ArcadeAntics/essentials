...
#         open(con, "r")
#     }, error = function(e) {
#         writeLines("\ndo something when connection was not opened\n")
#     }, else. = {
#         writeLines("\ndo something when connection was opened\n")
#     }, finally = {
#         close(con)
#     })
# }
...
#         writeLines("\nin 'else.' expression\n")
#     }, finally = {
#         writeLines("\nin 'finally' expression\n")
#     })
# }
#
#
# test({
#     writeLines("\ndoing code in 'expr' expression, expected behaviour is to evaluate 'else.' expression\n")
# })
#
#
# test({
#     writeLines("\ndoing code in 'expr' expression\n")
#     stop(errorCondition("a condition that will be caught, expected behaviour is to not evaluate 'else.' expression",
#         class = "catch.this"))
# })
#
#
# test({
#     writeLines("\ndoing code in 'expr' expression\n")
#     warning("a warning that will not be caught, expected behaviour is to evaluate 'else.' expression\n",
#             "since warnings don't stop execution")
# })
#
#
# tryCatch2({
#     test({
#         writeLines("\ndoing code in 'expr' expression\n")
#         stop(errorCondition("an error that will not be caught, expected behaviour is to not evaluate 'else.' expression",
#             class = "cant.catch.this"))
#     })
#     stop("should not reach here")
# }, cant.catch.this = invisible)
#
#
# # making sure that conditions which are caught are still printed correctly
# # (visibly or invisibly)
# stopifnot({
#     # should be visible
#     withVisible(tryCatch2({
#         stop("catch.this")
