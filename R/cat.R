cat_file <- function (file, show.all = FALSE, number.nonblank = FALSE, show.ends = FALSE,
...
cat_file(FILE, number.nonblank = TRUE)
system2("cat", shQuote(c(FILE, "--number-nonblank")))


cat_file(FILE, number = TRUE)
...
cat_file(FILE, show.ends = TRUE)
system2("cat", shQuote(c(FILE, "--show-ends")))


cat_file(FILE, show.ends = TRUE, number.nonblank = TRUE)
system2("cat", shQuote(c(FILE, "--show-ends", "--number-nonblank")))


cat_file(FILE, show.ends = TRUE, number = TRUE)
...
cat_file(FILE, squeeze.blank = TRUE)
...
cat_file(FILE, show.nonprinting = TRUE)
...
cat_file(FILE, show.all = TRUE)
system2("cat", shQuote(c(FILE, "--show-all")))


cat_file(FILE, show.all = TRUE, squeeze.blank = TRUE)
